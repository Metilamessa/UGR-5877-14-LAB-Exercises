      ...
      builder: (context) => CoursesListScreen(
        courses: [
          ...
          Course(
            ...
            description: 'This course covers discrete mathematics topics such as logic, sets, and relations.',
          ),
          Course(
            code: 'Site 322',
            title: 'Mobile Programming',
            description: 'This course focuses on developing mobile applications using various frameworks and technologies.',
          ),
        ],
        onTapped: (Course value) {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CourseDetailsScreen(course: value),
            ),
          );
        },
      ),
